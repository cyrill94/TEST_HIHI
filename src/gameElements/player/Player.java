...
public class Player implements Serializable{
	...
	private ArrayList<String> customCardSetCards;

	public Player(String dummy) throws FileNotFoundException {
	...
	public Player(String name, String password) throws FileNotFoundException{
			this.name = name;
			this.password = password;
			this.cardset = ServerModel.getCardSet(this.name);
			this.language = ServerModel.getLanguage(this.name);
			this.customCardSetCards = ServerModel.getCustomCardSet(this.name);
	...
	public void writeInDatabase(String name, String password, EnumCardSet enumcardset, EnumLanguage enumlanguage) {
		...
		if (enumcardset == EnumCardSet.custom) {
			cardSet = "custom";
		}
	...
	public void setCustomCardSetCards(ArrayList<String> arrList) {
		customCardSetCards.clear();
		for (String s:arrList) {
			customCardSetCards.add(s);
		}
	}
	
	
	public ArrayList<String> getCustomCardSetCards(){
		return this.customCardSetCards;
	}
